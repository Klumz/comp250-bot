...
public class TestBoi_v2 extends AbstractionLayerAI {
protected UnitTypeTable utt;
UnitType workerType;
UnitType baseType;

public TestBoi_v2(UnitTypeTable a_utt) {
    this(a_utt, new AStarPathFinding());
}

    
public TestBoi_v2(UnitTypeTable a_utt, PathFinding a_pf) {
    super(a_pf);
    reset(a_utt);
}
